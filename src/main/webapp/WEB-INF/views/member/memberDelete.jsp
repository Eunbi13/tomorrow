...
<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
	<h3>회원탈퇴 신청</h3>
	<br>
	<h5>회원 탈퇴 신청에 앞서 아래 내용을 반드시 확인해주세요.</h5>
		...
		<div class="form-group row">
			<div class="col-sm-6">
				<div class="form-checkbox">
					<input class="form-check-input accept" type="checkbox" >위 내용을 모두 확인하였습니다.<span>필수</span>
				</div>
			</div>
			<div class="col-sm-6">고객센터 1670-0000</div>
		</div>
		
		<div class="btn" id="running">탈퇴신청</div>
		<div class="btn" id="cancel">최소하기</div>
	</form>
